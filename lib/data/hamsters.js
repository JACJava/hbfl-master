console.log(Date().toLocaleString()+":  lib/simulation/hamsters.js, initial comment")
...
function updateRank (hamsters) {
  console.log(Date().toLocaleString()+":  lib/simulation/hamsters.js, in updated rank")
  ...
  totalledHamsters.sort((a, b) => {
    //console.log(Date().toLocaleString()+":  lib/simulation/hamsters.js, in totalled hamsters")
