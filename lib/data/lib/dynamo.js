...
console.log(Date().toISOString()+":  dynamo.js, initial comment")
    ...
    client.scan({ TableName }, (err, data) => {
      ...
      data.Items.forEach(function(item) {
                 console.log(
                      ...
                      item.name +": ",
                      item.type)
      console.log("GetAll function succeeded")
      })
    })
  })
}
...
function get (TableName, id) {
  return new Promise((resolve, reject) => {
    ...
    client.query(params, (err, data) => {
      ...
      console.log("Get function succeeded")
    })
  })
}
  ...
  return new Promise((resolve, reject) => {
    client.put({ TableName, Item }, (err, data) => {
      if (err) reject(err)
        ...
        console.log("Put function succeeded")
    })
  })
}
