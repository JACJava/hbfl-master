...
function putResults (hamsterId, results) {
  return new Promise((resolve, reject) => {
    ...
    .then((hamster) => {
      ...
      console.log(Date().toLocaleString()+":  hamster.results: "+JSON.stringify(hamster.results, null, 2))
      ...
      console.log(Date().toLocaleString()+":  hamster-update, attempting to update" + JSON.stringify(params, null, 2))
