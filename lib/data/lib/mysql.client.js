...
cloudformation.describeStackResource(params, function(err, data) {
  if (err) console.log(err, err.stack); // an error occurred
    ...
    // var PhysicalResourceID = data[0].PhysicalResourceId;
    // console.log(Date().toLocaleString()+":  PhysicalResourceID:  "+PhysicalResourceID);
  }
});

console.log(Date().toLocaleString()+":  obj again:  "+obj);
