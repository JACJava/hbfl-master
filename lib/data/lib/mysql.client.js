...
console.log(data.ResponseMetadata);
console.log("Outside ResponseMetadata with Stringify:  "+JSON.stringify(data.ResponseMetadata));

console.log(data.StackResourceDetail);
console.log("Outisde StackResourceDetail with Stringify:  "+JSON.stringify(data.StackResourceDetail));

console.log(data.StackResourceDetail.PhysicalResourceId);
console.log("Outside StackResourceDetail.PhysicalResourceId with Stringify:  "+JSON.stringify(data.StackResourceDetail.PhysicalResourceId));
